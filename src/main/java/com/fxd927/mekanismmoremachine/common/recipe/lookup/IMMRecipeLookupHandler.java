...
public interface IMMRecipeLookupHandler<RECIPE extends MekanismRecipe> extends IContentsListener {
    ...
    /**
     * Helper class that specifies the input cache's type for the recipe type. The reason it isn't defined in the main {@link IMMRecipeTypeProvider} is it isn't needed and
     ...
     * purposes.
     */
    interface IMSRecipeTypedLookupHandler<RECIPE extends MekanismRecipe, INPUT_CACHE extends IInputRecipeCache> extends IMMRecipeLookupHandler<RECIPE> {
