...
public abstract class MMTripleInputRecipeCache<INPUT_A, INGREDIENT_A extends InputIngredient<INPUT_A>, INPUT_B, INGREDIENT_B extends InputIngredient<INPUT_B>,
        ...
        CACHE_C extends IInputCache<INPUT_C, INGREDIENT_C, RECIPE>> extends MMAbstractInputRecipeCache<RECIPE> {
    ...
    protected MMTripleInputRecipeCache(MMRecipeType<RECIPE, ?> recipeType, Function<RECIPE, INGREDIENT_A> inputAExtractor, CACHE_A cacheA,
