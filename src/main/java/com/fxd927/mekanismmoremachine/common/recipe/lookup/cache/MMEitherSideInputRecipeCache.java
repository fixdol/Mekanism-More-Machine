...
public abstract class MMEitherSideInputRecipeCache<INPUT, INGREDIENT extends InputIngredient<INPUT>, RECIPE extends MekanismRecipe & BiPredicate<INPUT, INPUT>,
        CACHE extends IInputCache<INPUT, INGREDIENT, RECIPE>> extends MMAbstractInputRecipeCache<RECIPE> {
    ...
    protected MMEitherSideInputRecipeCache(MMRecipeType<RECIPE, ?> recipeType, Function<RECIPE, INGREDIENT> inputAExtractor,
