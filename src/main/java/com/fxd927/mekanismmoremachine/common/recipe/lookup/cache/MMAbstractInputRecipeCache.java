...
public abstract class MMAbstractInputRecipeCache<RECIPE extends MekanismRecipe> implements IInputRecipeCache {
    protected final MMRecipeType<RECIPE, ?> recipeType;
    protected boolean initialized;

    protected MMAbstractInputRecipeCache(MMRecipeType<RECIPE, ?> recipeType) {
